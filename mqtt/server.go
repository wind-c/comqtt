...
func (s *Server) Serve() error {
	//s.Log.Info().Str("version", Version).Msg("comqtt starting")
	defer s.Log.Info().Msg("comqtt server started")
...
func (s *Server) UnsubscribeClient(cl *Client) {
	...
	s.hooks.OnUnsubscribed(cl, packets.Packet{Filters: filters}, reasonCodes, counts)
}
...
func (s *Server) Close() error {
	...
	s.Log.Info().Msg("comqtt server stopped")
	return nil
}
